        ...
        <div class="timeline-block">
            <div class="panel panel-default">
                <div class="modal-header">
                    ...
                    <h4>
                        <a onclick="getSummaryPodKom('<?php echo site_url('user/get_kurs_profil')?>/<?php echo $kurs['idKurs']?>')" >
                        ...
                        <?php foreach ($ocenio as $oc): ?>
                            <li class="media">
                                <div class="media-left">
                                    ...
                                    <a onclick="getSummaryOcene('<?php echo site_url('user/get_clan_profil')?>/<?php echo $oc['idClan']?>', '<?php echo $oc['ime']?> <?php echo $oc['prezime']?>')"
