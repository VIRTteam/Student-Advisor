    ...
    <div class="container">
        ...
        <div class="media messages-container media-clearfix-xs-min media-grid" >
            ...
            <div class="media-body">
                ...
                <a onclick="getSummary('<?php echo site_url('user/get_clan_profil')?>/<?php echo $saKim['idClan']?>', '<?php echo $saKim['ime']?> <?php echo $saKim['prezime']?>')">
                            ...
                            <div class="media-body message">
                                <div class="content panel panel-default" >
                                    <div class="content panel-heading panel-heading-white">
                                        ...
                                        <a class="movie" onclick="getSummary('<?php echo site_url('user/get_clan_profil')?>/<?php echo $por['idPosiljalac']?>', '<?php echo $por['ime']?> <?php echo $por['prezime']?>')">
