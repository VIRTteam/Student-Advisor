...
<script>
    function izmeni_profil()
    {
        $.ajax({
            type: 'POST',
            url:'<?php echo site_url()?>/moderator/dohvati_izmenu_profila',
            async: false,
    ...
    function izmeni_sifru()
    {
        $.ajax({
            type: 'POST',
            url:'<?php echo site_url()?>/moderator/dohvati_izmenu_sifre',
            async: false,
            success: function (returnData) {
                $('#toggle_modal').html(returnData);
            }
    ...
    function obrisi_sliku()
    {
        $.ajax({
            type: 'POST',
            url:'<?php echo site_url()?>/moderator/brisanje_slike',
            async: false,
            success: function (returnData) {
